...
mega({
  ...
  xp_per_kill: 24, sprite: 'humans/brigand', weakness: 'slash', tags: ['human'],
...
mega({
  ...
  xp_per_kill: 12, sprite: 'beasts/corn_rat', weakness: 'slash', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 58, sprite: 'beasts/hedge_boar', weakness: 'stab', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 82, sprite: 'beasts/hedge_stalker', weakness: 'magic', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 95, sprite: 'humans/militia_captain', weakness: 'crush', tags: ['human', 'armoured'],
...
mega({
  ...
  xp_per_kill: 70, sprite: 'undead/plough_ghoul', weakness: 'slash', tags: ['undead'],
...
mega({
  ...
  aggressive: true, region: 'heartlands', slayer_task_eligible: false, slayer_level_required: 0,
  xp_per_kill: 44, sprite: 'humans/highwayman', weakness: 'magic', tags: ['human'],
...
mega({
  ...
  xp_per_kill: 120, sprite: 'beasts/rat_king', weakness: 'crush', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 68, sprite: 'humans/sow_witch', weakness: 'ranged', tags: ['human'],
...
mega({
  ...
  xp_per_kill: 140, sprite: 'construct/church_gargoyle', weakness: 'crush', tags: ['construct', 'armoured'],
...
mega({
  ...
  xp_per_kill: 78, sprite: 'undead/grave_spawn', weakness: 'slash', tags: ['undead'],
...
mega({
  ...
  xp_per_kill: 150, sprite: 'beasts/crypt_howler', weakness: 'ranged', tags: ['beast', 'undead'],
...
mega({
  ...
  xp_per_kill: 240, sprite: 'vampyre/nocturne_lord', weakness: 'slash', tags: ['vampyre', 'undead'],
...
mega({
  ...
  xp_per_kill: 180, sprite: 'beasts/werewolf_stalker', weakness: 'stab', tags: ['beast', 'werewolf'],
...
mega({
  ...
  xp_per_kill: 115, sprite: 'undead/bone_priest', weakness: 'ranged', tags: ['undead'],
...
mega({
  ...
  xp_per_kill: 205, sprite: 'vampyre/salt_vampire', weakness: 'crush', tags: ['vampyre', 'undead'],
...
mega({
  ...
  xp_per_kill: 48, sprite: 'undead/coffin_crawler', weakness: 'slash', tags: ['undead'],
...
mega({
  ...
  xp_per_kill: 88, sprite: 'humans/mourner', weakness: 'stab', tags: ['human'],
...
mega({
  ...
  xp_per_kill: 158, sprite: 'undead/chapel_revenant', weakness: 'ranged', tags: ['undead', 'spirit'],
...
mega({
  ...
  xp_per_kill: 36, sprite: 'beasts/blood_bat', weakness: 'crush', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 195, sprite: 'undead/marrow_wight', weakness: 'crush', tags: ['undead'],
...
mega({
  ...
  xp_per_kill: 55, sprite: 'spirit/lamplighter_ghost', weakness: 'ranged', tags: ['undead', 'spirit'],
...
mega({
  ...
  xp_per_kill: 105, sprite: 'humans/moon_cultist', weakness: 'ranged', tags: ['human'],
...
mega({
  ...
  aggressive: true, region: 'moryskah', slayer_task_eligible: false, slayer_level_required: 0,
  xp_per_kill: 170, sprite: 'humans/carriage_driver', weakness: 'stab', tags: ['human', 'undead'],
...
mega({
  ...
  xp_per_kill: 72, sprite: 'undead/whispering_skull', weakness: 'crush', tags: ['undead'],
...
mega({
  ...
  xp_per_kill: 68, sprite: 'undead/mummy_minor', weakness: 'slash', tags: ['undead'],
...
mega({
  ...
  xp_per_kill: 162, sprite: 'undead/mummy_greater', weakness: 'slash', tags: ['undead', 'armoured'],
...
mega({
  ...
  xp_per_kill: 290, sprite: 'undead/pharaoh_lich', weakness: 'ranged', tags: ['undead', 'boss'],
...
mega({
  ...
  xp_per_kill: 85, sprite: 'beasts/shield_scarab', weakness: 'crush', tags: ['beast', 'armoured'],
...
mega({
  ...
  xp_per_kill: 118, sprite: 'beasts/biter_scarab', weakness: 'slash', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 148, sprite: 'beasts/salt_stalker', weakness: 'ranged', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 96, sprite: 'spirit/dust_dweller', weakness: 'ranged', tags: ['elemental', 'spirit'],
...
mega({
  ...
  xp_per_kill: 198, sprite: 'spirit/dust_tyrant', weakness: 'ranged', tags: ['elemental', 'boss'],
...
mega({
  ...
  xp_per_kill: 182, sprite: 'spirit/sand_djinn', weakness: 'ranged', tags: ['elemental', 'spirit'],
...
mega({
  ...
  xp_per_kill: 135, sprite: 'construct/canopic_guardian', weakness: 'crush', tags: ['construct', 'armoured'],
...
mega({
  ...
  xp_per_kill: 62, sprite: 'beasts/glass_cobra', weakness: 'slash', tags: ['beast'],
...
mega({
  ...
  aggressive: true, region: 'boneyard', slayer_task_eligible: false, slayer_level_required: 0,
  xp_per_kill: 74, sprite: 'humans/tomb_raider', weakness: 'magic', tags: ['human'],
...
mega({
  ...
  xp_per_kill: 88, sprite: 'beasts/mirror_deer', weakness: 'ranged', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 114, sprite: 'beasts/glass_spider', weakness: 'crush', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 142, sprite: 'plant/corrupted_dryad', weakness: 'slash', tags: ['plant', 'spirit'],
...
mega({
  ...
  xp_per_kill: 105, sprite: 'beasts/thornback_elk', weakness: 'magic', tags: ['beast', 'plant'],
...
mega({
  ...
  xp_per_kill: 160, sprite: 'fey/fey_archer', weakness: 'magic', tags: ['spirit'],
...
mega({
  ...
  xp_per_kill: 188, sprite: 'construct/moonglass_warden', weakness: 'crush', tags: ['construct'],
...
mega({
  ...
  xp_per_kill: 74, sprite: 'plant/root_stalker', weakness: 'slash', tags: ['plant'],
...
mega({
  ...
  xp_per_kill: 128, sprite: 'undead/hollow_huntsman', weakness: 'magic', tags: ['undead'],
...
mega({
  ...
  xp_per_kill: 52, sprite: 'plant/ink_cap', weakness: 'crush', tags: ['plant'],
...
mega({
  ...
  xp_per_kill: 82, sprite: 'construct/clockwork_owl', weakness: 'crush', tags: ['construct'],
...
mega({
  ...
  xp_per_kill: 150, sprite: 'beasts/glass_wolf', weakness: 'crush', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 320, sprite: 'boss/king_of_the_wood', weakness: 'magic', tags: ['plant', 'boss'],
...
mega({
  ...
  xp_per_kill: 130, sprite: 'construct/rust_golem', weakness: 'crush', tags: ['construct', 'armoured'],
...
mega({
  ...
  xp_per_kill: 162, sprite: 'construct/clockwork_sentinel', weakness: 'magic', tags: ['construct', 'armoured'],
...
mega({
  ...
  xp_per_kill: 178, sprite: 'spirit/forge_wraith', weakness: 'ranged', tags: ['spirit', 'elemental'],
...
mega({
  ...
  xp_per_kill: 32, sprite: 'spirit/soot_sprite', weakness: 'ranged', tags: ['spirit', 'elemental'],
...
mega({
  ...
  xp_per_kill: 95, sprite: 'construct/gearbeast', weakness: 'crush', tags: ['construct'],
...
mega({
  ...
  xp_per_kill: 40, sprite: 'demon/bellows_imp', weakness: 'ranged', tags: ['demon', 'elemental'],
...
mega({
  ...
  aggressive: true, region: 'sootworks', slayer_task_eligible: false, slayer_level_required: 0,
  xp_per_kill: 84, sprite: 'humans/smoker_dwarf', weakness: 'stab', tags: ['human', 'dwarf'],
...
mega({
  ...
  xp_per_kill: 228, sprite: 'demon/furnace_horror', weakness: 'magic', tags: ['demon', 'elemental', 'armoured'],
...
mega({
  ...
  xp_per_kill: 115, sprite: 'undead/iron_wight', weakness: 'crush', tags: ['undead', 'armoured'],
...
mega({
  ...
  xp_per_kill: 145, sprite: 'beasts/anvil_ogre', weakness: 'magic', tags: ['beast', 'armoured'],
...
mega({
  ...
  xp_per_kill: 66, sprite: 'construct/steam_houndling', weakness: 'stab', tags: ['construct'],
...
mega({
  ...
  xp_per_kill: 125, sprite: 'spirit/slag_elemental', weakness: 'ranged', tags: ['elemental'],
...
mega({
  ...
  xp_per_kill: 118, sprite: 'beasts/brine_troll', weakness: 'magic', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 142, sprite: 'beasts/kraken_spawn', weakness: 'slash', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 106, sprite: 'undead/drowner', weakness: 'crush', tags: ['undead'],
...
mega({
  ...
  xp_per_kill: 88, sprite: 'vampyre/salt_vampire_spawn', weakness: 'crush', tags: ['vampyre', 'undead'],
...
mega({
  ...
  xp_per_kill: 168, sprite: 'beasts/tidewalker', weakness: 'magic', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 320, sprite: 'boss/kraken_matriarch', weakness: 'ranged', tags: ['beast', 'boss'],
...
mega({
  ...
  xp_per_kill: 72, sprite: 'beasts/reefdog', weakness: 'magic', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 96, sprite: 'beasts/coral_lancer', weakness: 'magic', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 132, sprite: 'undead/wreckmarrow', weakness: 'ranged', tags: ['undead'],
...
mega({
  ...
  xp_per_kill: 108, sprite: 'beasts/ashpool_drinker', weakness: 'ranged', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 54, sprite: 'humans/lamprey_rider', weakness: 'magic', tags: ['human'],
...
mega({
  ...
  xp_per_kill: 210, sprite: 'humans/sea_hag', weakness: 'ranged', tags: ['human', 'spirit'],
...
mega({
  ...
  xp_per_kill: 58, sprite: 'spirit/page_spawn', weakness: 'crush', tags: ['spirit'],
...
mega({
  ...
  xp_per_kill: 128, sprite: 'spirit/mirror_stalker', weakness: 'magic', tags: ['spirit'],
...
mega({
  ...
  xp_per_kill: 185, sprite: 'spirit/ink_shaped', weakness: 'ranged', tags: ['spirit'],
...
mega({
  ...
  xp_per_kill: 260, sprite: 'boss/forgotten_name', weakness: 'ranged', tags: ['spirit', 'boss'],
...
mega({
  ...
  xp_per_kill: 34, sprite: 'spirit/footnote_fiend', weakness: 'crush', tags: ['spirit'],
...
mega({
  ...
  xp_per_kill: 116, sprite: 'beasts/chapter_hound', weakness: 'magic', tags: ['beast', 'spirit'],
...
mega({
  ...
  xp_per_kill: 166, sprite: 'spirit/editor_wraith', weakness: 'ranged', tags: ['spirit', 'undead'],
...
mega({
  ...
  xp_per_kill: 100, sprite: 'beasts/spine_serpent', weakness: 'slash', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 148, sprite: 'beasts/glossary_ogre', weakness: 'magic', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 42, sprite: 'beasts/margin_spider', weakness: 'crush', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 140, sprite: 'undead/librarian_shade', weakness: 'crush', tags: ['undead', 'spirit'],
...
mega({
  ...
  xp_per_kill: 218, sprite: 'demon/printer_demon', weakness: 'magic', tags: ['demon'],
...
mega({
  ...
  xp_per_kill: 128, sprite: 'beasts/lens_cat', weakness: 'crush', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 164, sprite: 'beasts/prism_stalker', weakness: 'magic', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 194, sprite: 'humans/crystal_hunter', weakness: 'ranged', tags: ['human', 'armoured'],
...
mega({
  ...
  xp_per_kill: 232, sprite: 'spirit/glass_djinn', weakness: 'ranged', tags: ['spirit', 'elemental'],
...
mega({
  ...
  xp_per_kill: 66, sprite: 'beasts/shard_lizard', weakness: 'crush', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 146, sprite: 'beasts/mirage_leopard', weakness: 'ranged', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 82, sprite: 'beasts/sunburst_camel', weakness: 'stab', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 180, sprite: 'spirit/crystal_wraith', weakness: 'crush', tags: ['spirit', 'undead'],
...
mega({
  ...
  xp_per_kill: 110, sprite: 'beasts/shard_falcon', weakness: 'crush', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 330, sprite: 'boss/sunking', weakness: 'ranged', tags: ['spirit', 'boss'],
...
mega({
  ...
  xp_per_kill: 260, sprite: 'undead/revenant_knight', weakness: 'magic', tags: ['undead', 'armoured'],
...
mega({
  ...
  xp_per_kill: 310, sprite: 'undead/revenant_dragon', weakness: 'stab', tags: ['undead', 'dragon'],
...
mega({
  ...
  xp_per_kill: 248, sprite: 'demon/chaos_demon', weakness: 'ranged', tags: ['demon'],
...
mega({
  ...
  aggressive: true, region: 'wilds', slayer_task_eligible: true, slayer_level_required: 85,
  xp_per_kill: 305, sprite: 'demon/greater_chaos_demon', weakness: 'ranged', tags: ['demon', 'boss'],
...
mega({
  ...
  xp_per_kill: 290, sprite: 'undead/blood_reaper', weakness: 'slash', tags: ['undead'],
...
mega({
  ...
  xp_per_kill: 200, sprite: 'beasts/chaos_troll', weakness: 'magic', tags: ['beast'],
...
mega({
  ...
  xp_per_kill: 240, sprite: 'beasts/chaos_giant', weakness: 'ranged', tags: ['beast', 'boss'],
...
mega({
  ...
  xp_per_kill: 178, sprite: 'undead/pker_ghost', weakness: 'magic', tags: ['undead', 'human'],
...
mega({
  ...
  xp_per_kill: 88, sprite: 'demon/imbued_imp', weakness: 'ranged', tags: ['demon'],
...
mega({
  ...
  xp_per_kill: 340, sprite: 'beasts/wilderness_wyrm', weakness: 'ranged', tags: ['beast', 'dragon', 'boss'],
...
mega({
  ...
  aggressive: true, region: 'wilds', slayer_task_eligible: false, slayer_level_required: 0,
  xp_per_kill: 188, sprite: 'humans/fallen_paladin', weakness: 'stab', tags: ['human', 'undead'],
...
mega({
  ...
  xp_per_kill: 260, sprite: 'humans/skull_priestess', weakness: 'ranged', tags: ['human', 'undead'],
...
mega({
  ...
  xp_per_kill: 156, sprite: 'spirit/tainted_nymph', weakness: 'ranged', tags: ['spirit'],
...
mega({
  ...
  xp_per_kill: 360, sprite: 'boss/bone_colossus', weakness: 'magic', tags: ['undead', 'boss', 'armoured'],
...
mega({
  ...
  xp_per_kill: 400, sprite: 'boss/black_stone_warden', weakness: 'ranged', tags: ['construct', 'boss'],
